    ...
    <>
      <main className={styles.main}>
        ...
        <p className={styles.pageDescription}>
          Highlight.js uses the global <code>document</code> keyword for
          highlighting code. <br />
          Using the <code>React.useEffect</code> hook will make it highlight the
          desired content on the client side, once the component has been
          mounted.
        </p>
